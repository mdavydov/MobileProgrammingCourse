...
## Лекція 3-4. Основи розроблення для платформи Android. Мова програмування Java.
...
## Лекція 5-6. Розроблення для Android: інтерфейсні елементи, анімації, збереження даних, мережева взаємодія, використання  С++.
...
## Лекція 7-8. Проектування мобільних додатків. Від вимог до інфраструктури.
...
## Лекція 9-10. Розроблення для платформи iOS
...
## Лекція 11-12. Програмування графічних мобільних додатків з використанням OpenGL ES, Metal, Vulkan
...
## Лекція 13-14. Засоби кросплатформного програмування.
1. Xamarin
1. JQuery Mobile
1. Unity 3D
