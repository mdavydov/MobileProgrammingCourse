...
## Лекції 9-10. Розроблення для платформи iOS
...
## Лекції 11-12. Програмування графічних мобільних додатків з використанням OpenGL ES, Metal, Vulkan
...
## Лекції 13-14. Засоби кросплатформного програмування.
1. Xamarin
1. JQuery Mobile
1. Unity 3D
